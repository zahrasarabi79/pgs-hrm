        ...
        detailsContent={
          <Stack spacing={2}>
            ...
            <MessageSection
              ...
              handleChange={(e: ChangeEvent<HTMLInputElement>) =>
                handleChangeMessage(e, dispatch, properties, 'text-area-box', 'min', 'validations')
              }
            />
          </Stack>
        }
        ...
        detailsContent={
          <Stack spacing={2}>
            ...
            <MessageSection
              ...
              handleChange={(e: ChangeEvent<HTMLInputElement>) =>
                handleChangeMessage(e, dispatch, properties, 'text-area-box', 'max', 'validations')
              }
            />
          </Stack>
        }
...
export default TextAreaBoxValidation;
